...
CREATE TABLE IF NOT EXISTS `mydb`.`VOTANTE` (
  ...
  `LISTA_NOMINAL` TINYINT(1) NOT NULL,
  `LISTA_NOMINAL_ORDEN` TINYINT(4) NOT NULL,
  `MEXICANO` TINYINT(1) NOT NULL,
  `start_date` TIMESTAMP(12) NOT NULL,
  `end_date` TIMESTAMP(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`MIEMBRO` (
  ...
  `SUPLENTE_SUPLENTE_INE/PASAPORTE` INT NOT NULL,
  ...
  INDEX `fk_MIEMBRO_SUPLENTE1_idx` (`SUPLENTE_SUPLENTE_INE/PASAPORTE` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_MIEMBRO_SUPLENTE1`
    FOREIGN KEY (`SUPLENTE_SUPLENTE_INE/PASAPORTE`)
