...
export class LoadDataComponent implements OnInit {
  ...
  submitMesa() {
    console.log(this.mesaModel);
  }

  submitPartido(){
    console.log(this.partidoModel);
  }

  submitVotante(){
    console.log(this.votanteModel);
  }

  submitMunicipal(){
    console.log(this.municipalModel);
  }

  submitFederal(){
    console.log(this.federalModel);
  }
